...
@GetMapping("/delBook/{traineeId}")
public ResponseEntity<Boolean> delTrainer(@PathVariable("traineeId") int traineeId) {
	
	Boolean status = traineeservice.delet(traineeId);
